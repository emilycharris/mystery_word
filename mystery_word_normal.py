...
print("Let's get started. The secret word contains " + str(len(secret_word)) + " letters.")

#Ask the user to supply one guess (i.e. letter) per round.
#This letter can be upper or lower case and it should not matter.
#Assume the user will only submit one letter (see Hard Mode for more on this.)
